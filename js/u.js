...
const l = [
  ...
  ['F900-FAFF', '中日韩相容表意文字'],
  ['FB00-FB4F', '字母表达形式'],
  ['FB50-FDFF', '阿拉伯文表达形式-A'],
  ['FE00-FE0F', '变体选择符'],
  ['FE10-FE1F', '竖排形式'],
  ['FE20-FE2F', '组合用半符号'],
  ['FE30-FE4F', '中日韩相容形式'],
  ['FE50-FE6F', '小写变体形式'],
  ['FE70-FEFF', '阿拉伯文表达形式-B'],
  ['FF00-FFEF', '半形及全形字元'],
  ['FFF0-FFFF', '特殊'],
];
...
const d = function (a, b, c) {
  ...
  table.setAttribute('class', "text-sm text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400");
